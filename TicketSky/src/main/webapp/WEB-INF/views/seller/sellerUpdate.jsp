        ...
        <form class="form-horizontal" id="enrollform" action="${path }/user/userUpdateEnd" method="post" onsubmit="return fn_enroll_validate();">
          <div class="form-group" >
           ...
           <div class="form-group">
            ...
            <div class="col-xs-9">
              <input type="password" name="oripassword" class="form-control" id="oripassword" placeholder="비밀번호" required>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-xs-9">
                <input type="text" name="phone" class="form-control"  value="${memberLoggedIn.phone }" placeholder="휴대폰번호" required>
