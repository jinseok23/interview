      ...
      <div class="container" style="">
        ...
        <form class="form-horizontal" id="enrollform" action="${path }/user/adminUserUpdateEnd" method="post" onsubmit="return fn_enroll_validate();">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-9">
              <input type="email" name="email" class="form-control"  value="${m.email }"id="inputRipple" placeholder="이메일" required>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <c:set var="tel" value="${fn:split(m.address,',')}" />
            ...
            <div class="form-group">
              ...
              <div class="col-xs-9">
                <input type="text" name="phone" class="form-control"  value="${m.phone }" placeholder="휴대폰번호" required>
